...

{
    ...
    GPT12E_T6CON|=1<<15; // Bit 15 (Reload from register CAPREL Enabled)
        ...
        GPT12E_T6CON|= 1<<12; // GPT2 Block Prescaler Control  /16

        GPT12E_T6CON|=7; // Timer T6 Input Parameter Selection /256 , also 20KHZ Frequenz
    ...
    P4_IN_P4 = 0x0000;
        ...
        CC2_M4=1; // steigende Flanke

        CC2_CC16IC|=0x44; // 0100 0100
